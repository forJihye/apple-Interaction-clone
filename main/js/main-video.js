...
(() => {
  ...
  function playAnimation() {
    ...
    if (currentScene === 0) {
      ...
      elms.videoImages[sequence] && elms.context.drawImage(elms.videoImages[sequence], 0, 0);
      ...
      elms.videoImages[sequence2] && elms.context.drawImage(elms.videoImages[sequence2], 0, 0);
